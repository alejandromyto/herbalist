...
# git clone https://github.com/apilogicserver/herbalist.git
# cd herbalist
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name herbalist --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
